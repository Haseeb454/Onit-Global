...
const TestimonialsSection = () => {
  const testimonials = [
    {
      id: 1,
      quote: "Onit Global transformed our digital operations seamlessly. Their team implemented cutting-edge solutions that improved efficiency across all departments. The project was delivered on time and exceeded expectations.",
      name: "James Carter",
    ...
    {
      id: 2,
      quote: "Working with Onit Global was a game-changer. Their expertise in cloud technologies and software integration streamlined our processes and boosted overall productivity.",
      name: "Olivia Bennett",
    ...
    {
      id: 3,
      quote: "The Onit Global team is highly professional and responsive. They delivered a scalable solution that meets our evolving business needs. Communication throughout the project was excellent.",
      name: "Ethan Reynolds",
    ...
    {
      id: 4,
      quote: "Thanks to Onit Global, our platform is faster, more secure, and easier to maintain. Their innovative approach and attention to detail helped us achieve our digital transformation goals quickly.",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight mb-6">
            Hear What Our <br /> <span className="text-[#B82968]">Clients</span> Have to Say
          </h2>
